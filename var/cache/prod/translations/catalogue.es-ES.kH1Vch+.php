...
$catalogue = new MessageCatalogue('es-ES', array (
  ...
  array (
    ...
    'PrestaShop Design allows you to easily and rapidly customize your website theme and autonomously adapt the appearance of your store, brand image and preferences without needing any technical expertise.' => 'PrestaShop Design le permite personalizar fácil y rápidamente el tema de su sitio web y adaptar de forma autónoma el aspecto de su tienda, su imagen de marca y sus preferencias sin necesidad de conocimientos técnicos.',
    'Uncategorized colors' => 'Colores sin categoría',
    'Uncategorized fonts' => 'Fuentes no clasificadas',
    'This font is in your theme but is not specific to any category.' => 'Esta fuente está en tu tema pero no es específica de ninguna categoría.',
    'Classic theme is not installed.' => 'El tema Clásico no está instalado.',
    'Enabling theme failed. Please use "Theme" tab to enable theme.' => 'No se ha podido habilitar el tema. Utiliza la pestaña "Tema" para activar el tema.',
    'The name of the color palette can\'t be empty.' => 'El nombre de la paleta de colores no puede estar vacío.',
    'Connection with database to update new color palette failed. Please try again.' => 'Ha fallado la conexión con la base de datos para actualizar la nueva paleta de colores. Inténtalo de nuevo.',
    'Creation of new color styles failed.' => 'Falló la creación de nuevos estilos de color.',
    'File in module does not exist or not writable. Please check user permissions in server' => 'El archivo del módulo no existe o no es editable. Comprueba los permisos de usuario en el servidor',
    'Process of creating new styles file failed. Please try again.' => 'El proceso de creación de nuevos estilos ha fallado. Inténtalo de nuevo.',
    'Replacing new theme styles file failed. Please try again. ' => 'Error al reemplazar el nuevo archivo de estilos de temas. Inténtalo de nuevo. ',
    'The color palette update failed. Please try again.' => 'Error al actualizar la paleta de color. Inténtalo de nuevo.',
    'Changes have been saved.' => 'Se han guardado los cambios.',
    'Failed to add or update the font.' => 'Error al añadir o actualizar la fuente.',
    'Failed to delete the font.' => 'No se pudo eliminar la fuente.',
    'Invalid font style is provided.' => 'Se ha proporcionado un estilo de fuente no válido.',
    'The font customization is only available with compatible themes.' => 'La personalización de fuentes solo está disponible con temas compatibles.',
    'Failed to receive font from google fonts' => 'Error al recibir la fuente de google fonts',
    'Failed to generate stylesheet' => 'Error al generar la hoja de estilo',
    'The fonts update failed. Please try again.' => 'Error al actualizar las fuentes. Inténtalo de nuevo.',
    'The %destination% logo has been added.' => 'Se ha añadido el logotipo de %destination%.',
    'Use same header logo is unavailable.' => 'Utilizar el mismo logotipo de cabecera no disponible.',
    'Header logo applied successfully.' => 'Logotipo de cabecera bien aplicado.',
    'Favicon updated successfully' => 'El favicon se ha actualizado correctamente',
    'header' => 'cabecera',
    'email' => 'correo electrónico',
    'invoice' => 'factura',
    'The image format is not recognized, allowed formats are: %formats%.' => 'No se reconoce el formato de imagen, los formatos permitidos son: %formats%.',
    'The image format is not recognized, allowed format is: .%format%.' => 'No se reconoce el formato de imagen, el formato permitido es:.%format%.',
    'The format is invalid, allowed formats are %allowed_formats%.' => 'El formato no es válido, los formatos permitidos son %allowed_formats%.',
    'The logo destination is invalid. Please try again.' => 'La colocación del logo no es válida. Inténtalo de nuevo.',
    'The .svg format is not compatible.' => 'El formato .svg no es compatible.',
    'The logo upload failed. Please try again.' => 'Error al cargar el logo. Inténtalo de nuevo.',
    'The file is too large (limit of %size% bytes).' => 'El archivo es demasiado grande (límite de %size% bytes).',
    'Failed to initialize image creation. PHP GD extension missing.' => 'Fallo al inicializar la creación de imágenes. Falta la extensión PHP GD.',
    'Failed convert text to image. Please select different font.' => 'Error al convertir texto en imagen. Selecciona otra fuente.',
    'This font does not exist. Please choose another font.' => 'Esta fuente no existe. Elige otra.',
    'The creation of a temporary directory to store the uploaded font has failed. Please check the user permissions on your system.' => 'La creación de un directorio temporal para almacenar la fuente cargada ha fallado. Comprueba los permisos de usuario en tu sistema.',
    'Failed to convert text to logo. Please try again.' => 'Error al convertir texto en logotipo. Inténtalo de nuevo.',
    'Failed to retrieve font. Please use different font.' => 'No se ha podido recuperar la fuente. Utiliza otra diferente.',
    'The text may not be longer than 64 characters.' => 'El texto no puede tener más de 64 caracteres.',
    'The theme %theme% has been set as active theme.' => 'El tema %theme% se ha establecido como tema activo.',
    'Theme imported successfully' => 'Tema importado con éxito',
    'The theme %theme% cannot be deleted because it\'s the default Prestashop theme.' => 'El tema %theme% no se puede eliminar porque es el tema por defecto de PrestaShop.',
    'The theme %themeName% has been deleted.' => 'El tema %themeName% se ha eliminado.',
    'Please select correct theme\'s import source.' => 'Selecciona la fuente de importación del tema.',
    'Failed to find imported theme.' => 'No se ha podido encontrar el tema importado.',
    'File does not exist or bad type uploaded.' => 'El archivo no existe o se ha cargado un tipo de archivo incorrecto.',
    'There is already a theme %theme_name% in your themes folder. Remove it if you want to continue.' => 'Ya hay un tema %theme_name% en tu carpeta de temas. Elimínalo si quieres continuar.',
    'Allowed file size exceeded for uploaded theme.' => 'Se ha superado el tamaño de archivo permitido para el tema cargado.',
    'The file type is invalid. Allowed file type is .zip.' => 'El tipo de archivo no es válido. El tipo de archivo permitido es .zip.',
    'Unknown error occurred. Please try again.' => 'Ha ocurrido un error. Inténtalo de nuevo.',
    'Themes can only be imported in single store context.' => 'Los temas solo se pueden importar en el contexto de una sola tienda.',
    ...
    'The import of your theme failed. Please try again.' => 'La importación de tu tema ha fallado. Inténtalo de nuevo.',
    'Module upgrade failed. Please try upgrading it through module manager' => 'Error al actualizar el módulo. Intenta actualizarlo a través del gestor de módulos',
    'Your module has been successfully upgraded!' => 'Tu módulo se ha actualizado correctamente.',
    'Theme & Logo' => 'Tema y logotipo',
    'Background' => 'Fondo',
    'Body text' => 'Cuerpo del texto',
    'Background and discounted prices' => 'Fondo y precios con descuento',
    'Main title' => 'Título principal',
    'The main title of a page has to use the Heading 1 format (e.g. Product page name).' => 'El título principal de una página debe utilizar el formato Heading 1 (por ejemplo, Nombre de la página del producto).',
    'Section title' => 'Título de sección',
    'Section titles mark the main sections of your page and use Heading 2 format (e.g. Popular products).' => 'Los títulos de sección marcan las secciones principales de tu página y utilizan el formato Heading 2 (por ejemplo, Productos populares).',
    'Footer title' => 'Título del pie de página',
    'Footer titles structure your footer and use Heading 3 format (e.g. Contact us).' => 'Los títulos de pie de página estructuran el pie de página y utilizan el formato Heading 3 (por ejemplo, Contacto).',
    'Subcategory title' => 'Título de subcategoría',
    'Subcategory titles help structure your category page and use Heading 5 format (e.g. Men).' => 'Los títulos de las subcategorías ayudan a estructurar tu página de la categoría y utilizan el formato Heading 5 (por ejemplo, Hombres).',
    'Product attributes' => 'Atributos del producto',
    'Product attributes of your Category page use Heading 6 format (e.g. Size, Color). ' => 'Los atributos de producto de tu página Categoría utilizan el formato Heading 6 (por ejemplo, Talla, Color). ',
    'Body copy' => 'Cuerpo del texto',
    'The body copy format is used for the main content in the pages (e.g. Product description).' => 'El formato del cuerpo del texto se utiliza para el contenido principal de las páginas (por ejemplo, descripción de producto).',
    'Links' => 'Enlaces',
    'This is used for links in the page (e.g. All sale products).' => 'Se utiliza para los enlaces de la página (por ejemplo, Todos los productos en venta).',
    'Headings' => 'Título',
    'Headings are titles that help organize content on a page and can be used to create sections.' => 'Los encabezados son títulos que ayudan a organizar el contenido de una página y pueden utilizarse para crear secciones.',
    'Content' => 'Contenido',
    'Content refers to any information written within the pages. It is used to instruct, to provide descriptions, to explain the benefits of a product or highlight any feature.' => 'El contenido se refiere a cualquier información escrita en las páginas. Se utiliza para informar, proporcionar descripciones, explicar las ventajas de un producto o destacar alguna característica.',
    'Main button' => 'Botón principal',
    'Secondary button' => 'Acción secundaria',
    'Discounts' => 'Descuentos',
    'You are about to import a logo in svg format. This format being incompatible with the email and invoice logos, these will retain the current logo.' => 'Estás a punto de importar un logotipo en formato svg. Este formato no es compatible con los logos de correo electrónico y factura que conservarán el logotipo actual.',
    'Theme settings' => 'Configuración del tema',
    'Themes' => 'Temas',
    'Theme modules' => 'Módulos de temas',
    'Use this color palette' => 'Usar esta paleta de colores',
    'Colors' => 'Colores',
    'Customize the colors by writing the [1]hex color code[/1] or by using the color picker.' => 'Personalizar los colores escribiendo el código de color hexadecimal [1][/1] o utilizando el selector de color.',
    'Customize your theme image' => 'Personaliza la imagen de tu tema',
    'Choose a theme from the list in the Themes page.' => 'Elegir un tema de la lista de la página Temas.',
    'Go to Themes' => 'Ir a Temas',
    'Use a compatible theme to customize colors' => 'Utiliza un tema compatible para personalizar los colores',
    'Use a compatible theme to customize fonts' => 'Utiliza un tema compatible para personalizar las fuentes',
    'Try your font' => 'Probar tu fuente',
    'Current favicon' => 'Favicon actual',
    'Import favicon' => 'Importar favicon',
    'Accepted format: .ico.' => 'Formato aceptado: .ico.',
    'Save favicon' => 'Guardar favicon',
    'Favicon' => 'Favicon',
    'The favicon is a small icon that appears on the left in the address bar, tabs, favorites, etc.' => 'El favicon es un icono pequeño que aparece a la izquierda en la barra de direcciones, pestañas, favoritos, etc.',
    'My store' => 'Mi tienda',
    'Create your own with our [1]favicon generator[/1] to reinforce your brand image.' => 'Crea tu favicon con nuestro [1]generador de favicons[/1] para reforzar tu imagen de marca.',
    'Header' => 'Cabecera',
    'Email' => 'Correo electrónico',
    'Invoice' => 'Factura',
    'Logos' => 'Logotipos',
    'The header logo appears on all pages of your store.' => 'El logotipo de la cabecera aparece en todas las páginas de tu tienda.',
    'The recommended size for the default theme: height 40 px and width 200 px.' => 'El tamaño recomendado para el tema predeterminado: 40 px de alto y 200 px de ancho.',
    'Unless you change your mind, the same logo will be used on your emails and invoices.' => 'A menos que cambies de opinión, se utilizará el mismo logotipo en tus correos electrónicos y en tus facturas.',
    'Save' => 'Guardar',
    'Save logo image for %form%' => 'Guardar la imagen del logotipo para %form%',
    'Current logo' => 'Logotipo actual',
    'Current logo preview' => 'Vista previa del logotipo actual',
    'Import logo' => 'Importar logotipo',
    'Accepted formats: %formats%.' => 'Formatos aceptados: %formats%.',
    'Text' => 'Texto',
    ' Use header logo' => ' Utilizar el logotipo de la cabecera',
    'Save the use of header logo for %form%' => 'Guardar el uso del logotipo de la cabecera para %form%',
    'Logo type' => 'Tipo de logotipo',
    'Image' => 'Imagen',
    'Import logo image' => 'Importar la imagen del logotipo',
    'Create text logo' => 'Crear un logotipo de texto',
    'Text of your logo' => 'Texto de tu logotipo',
    'Always check the final result on your store as it may differ from the preview, depending on your theme.' => 'Comprueba siempre el resultado final en tu tienda, ya que puede diferir de la vista previa, dependiendo de tu tema.',
    'Later' => 'Más tarde',
    'The %s% theme has just been added.' => 'El tema %s% se acaba de añadir.',
    'Use this theme' => 'Utilizar este tema',
    'desktop preview of the theme %theme%' => 'vista previa del tema %theme% en el escritorio',
    'Customize' => 'Personalizar',
    'mobile preview of the theme %theme%' => 'vista previa del tema %theme% en un dispositivo móvil',
    'Current theme' => 'Tema actual',
    'The theme defines the appearance of your site.' => 'El tema define el diseño de tu página.',
    'Delete' => 'Eliminar',
    'Delete this theme?' => '¿Eliminar este tema?',
    'You are about to delete the %theme% theme. This action is irreversible. ' => 'Estás a punto de eliminar el tema %theme%. Esta acción es irreversible. ',
    'Import from computer' => 'Importar desde el ordenador',
    'ZIP file' => 'Archivo ZIP',
    'Browse the files on your computer and select the ZIP file containing your new theme.' => 'Busca en los archivos de tu ordenador y selecciona el archivo ZIP que contiene tu nuevo tema.',
    'Import from FTP' => 'Importar desde FTP',
    'Select archive' => 'Seleccionar archivo',
    'This field shows the ZIP files present in the "/themes" folder.' => 'Este campo muestra los archivos ZIP existentes en la carpeta «/temas».',
    'Import from web' => 'Importar desde la web',
    'Import' => 'Importar',
    'Archive URL' => 'URL del archivo',
    'Specify the full URL of the ZIP file that contains your new theme. For example, "http://example.com/files/theme.zip".' => 'Especifica la URL completa del archivo ZIP que contiene tu nuevo tema. Por ejemplo, «http://example.com/files/theme.zip».',
    'Use' => 'Utilizar',
    'Use this theme?' => '¿Utilizar este tema?',
    'close' => 'cerrar',
    'Your current %currentTheme% theme will be replaced by the %new_theme% theme.' => 'Tu tema actual %currentTheme% será reemplazado por el tema %new_theme%.',
    'It is important to check the compatibility of your modules with the %new_theme% theme in a test environment.' => 'Es importante comprobar la compatibilidad de tus módulos con el tema %new_theme% en un entorno de pruebas.',
    'v%version%' => 'v%version%',
    'Developed by %author%' => 'Desarrollado por %author%',
    'View demo' => 'Ver demo',
    'Theme library' => 'Biblioteca de temas',
    'Choose the default Classic theme for a simple and minimalist store.' => 'Elige el tema Classic predeterminado para conseguir una tienda sencilla y minimalista.',
    'You can choose other themes with more advanced customization from this list of themes.' => 'Puedes elegir otros temas con una personalización más avanzada de esta lista de temas.',
    'Import theme' => 'Importar tema',
    'Remove file' => 'Eliminar archivo',
    'We have improved the Design section of your back office' => 'Hemos mejorado la sección de Diseño de tu back office',
    'Enjoy a better experience and benefit from the latest improvements. Your settings and data will be preserved.' => 'Consigue una mejor experiencia y aprovecha las últimas mejoras. Tu configuración y tus datos se conservarán.',
    'Activate new features' => 'Activar nuevas características',
    'Hexadecimal color' => 'Código de color hexadecimal',
    'Copy' => 'Copiar',
    'Copied' => 'Copiado',
    'Enter a valid [1]hex code[/1] or use the color picker.' => 'Introduce un código hexadecimal [1]válido[/1] o utiliza el selector de color.',
    '[1]Select[/1] a file or drag and drop' => '[1]Seleccionar[/1] un archivo o arrastrar y soltar',
    'Cancel' => 'Cancelar',
    'Unsaved changes' => 'Cambios descartados',
  ...
  array (
    'We have improved the Design section of your back office' => 'Hemos mejorado la sección de diseño de tu «back office»',
    'Enjoy a better experience and benefit from the latest improvements. Your settings and data will be preserved.' => 'Disfruta de una mejor experiencia y aprovecha las últimas mejoras. Tu configuración y tus datos se conservarán.',
    'Activate new features' => 'Activar nuevas funciones',
  ),
  'ModulesMboAddons' => 
  array (
